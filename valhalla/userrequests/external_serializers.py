...
class BlockMoleculeSerializer(serializers.Serializer):
    ...
    ag_filter = serializers.CharField(required=False)
    ag_name = serializers.CharField(required=False)
    user_id = serializers.CharField()
    defocus = serializers.CharField(required=False)
    spectra_slit = serializers.CharField(required=False)
    priority = serializers.IntegerField()
    failed = serializers.BooleanField()
    inst_name = serializers.CharField(required=False)
    ...
    ag_exp_time = serializers.CharField(required=False)
    tag_id = serializers.CharField()
    group = serializers.CharField()
    exposure_count = serializers.IntegerField(required=False)
    acquire_radius_arcsec = serializers.CharField(required=False)
    ag_mode = serializers.CharField(required=False)
