...
from valhalla.proposals.views import MembershipDeleteView, SemesterDetailView, MembershipLimitView
from valhalla.proposals.views import GlobalMembershipLimitView
